                    ...
                    <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                {errors.email && <span className="text-fuchsia-600 ">This field is required</span>}
                            </div>
                            <div className="form-control">
                                <label className="label">
                                ...
                                {errors.password?.type === "minLength" && (
                                    <p className="text-fuchsia-600">Password must be 6 characters</p>
                                )}
                                {errors.password?.type === "maxLength" && (
                                    <p className="text-fuchsia-600">Password must be less then 20 characters</p>
                                )}
                            </div>
                            <div className="form-control mt-6">
                                <input className="btn bg-fuchsia-600  text-white hover:text-fuchsia-600" type="submit" value="SignUp" />
